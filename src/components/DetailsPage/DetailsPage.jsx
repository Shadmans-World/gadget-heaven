...
const DetailsPage = () => {
  ...
  const { items, addToCart } = useContext(GadgetsContext);
        ...
        <div className="flex gap-5">
          ...
          <div className="w-[60%] flex flex-col gap-y-4 pt-10 pb-10">
            ...
            <div className="flex gap-3 items-center">
              <button onClick={() => addToCart(product)} className="flex items-center gap-3 p-3 border-2 bg-customPurple rounded-xl text-white">
                Add to cart <span><LuShoppingCart className="text-2xl" /></span>
              </button>

              <Link className="bg-white rounded-full h-[40px] p-2 border-2">
